 ...
 <main>
   ...
   <div class="container">
     <div class="row contenedor">
       <div class="col s12">
         <h4 class="center-align">Personas</h4>
          ...
          <!-- ESTA ES LA LISTA DE LAS EMPRESAS -->
           <ul class="collapsible" data-collapsible="accordion">
            ...
            <?php 
              ...
              $cont = 0;
                while($fila = mysqli_fetch_array($resultado)){
                 echo ' <li>
              <div class="collapsible-header active"><i class="material-icons">perm_identity</i>'.$fila["usuario"].'</div>
              <div class="collapsible-body">
                <p>
                  <b>Usuario: </b> '.$fila['usuario'].'<br>
                  <b>Nombre: </b> '.$fila['nombre'].'<br>
                  <b>Correo: </b> '.$fila['correo'].'<br>
                  <b>Rol: </b> '.$fila['rol'].'
                  </p>
              </div>
            </li>';
            $cont++;
                ...
                if($cont == 0){
                  echo ' <li>
              <div class="collapsible-header active"><i class="material-icons">filter_drama</i>No hay personas aun</div>
            </li>';
                }
