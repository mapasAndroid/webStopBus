...
//nos conectamos con la bd y hacemos el udpate
          ...
          $consulta = "update pasajero set usuario='".$usuario."', nombre ='".$nombre."', correo='".$correo."' , password='".$contra."', actualizacion='".$actua."',  rol='".$rol."', nit_empresa = ".$empresa." where usuario='".$personaActual."'";
