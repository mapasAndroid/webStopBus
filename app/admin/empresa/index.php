  ...
  <main>
   ...
   <div class="container">
     <div class="row contenedor">
       <div class="col s12">
         <h4 class="center-align">Empresas</h4>
         <div class="listaEmpresas">
          ...
          <ul class="collapsible" data-collapsible="accordion">
            ...
            while($fila = mysqli_fetch_array($resultado)){
             ...
             <b>Direcci&oacute;n: </b> '.$fila['direccion'].'<br>
             <b>Tel&eacute;fono: </b> '.$fila['telefono'].'
             </p>
             </div>
             </li>';
             $cont++;
           ...
           if($cont == 0){
            echo ' <li>
            <div class="collapsible-header active"><i class="material-icons">filter_drama</i>No hay empresas aun</div>
            </li>';
          }
