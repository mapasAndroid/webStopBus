      ...
      <div class="col s12">
        <div class="row">
          <form method="post" action="registrar.php" class="col s12 margen-admin">
              <h4 class="center-align titulo">Registrar empresa</h4>

              <div class="row">
                <div class="input-field col s8 offset-s2">
                  <i class="material-icons prefix">assignment_ind</i>
                  <input id="r_nit" type="text" class="validate" name="nit" required>
              ...
              <div class="row">
                <div class="input-field col s8 offset-s2">
                 ...
                 <input id="r_nombre" type="text" name="nombre" required>
              ...
              <div class="row">
                <div class="input-field col s8 offset-s2">
                 ...
                 <input id="r_direccion" name="direccion" type="text" value="" size="69" required>
              ...
              <div class="row">
                <div class="input-field col s8 offset-s2">
                 ...
                 <input id="r_telefono" type="text" name="telefono" required>
